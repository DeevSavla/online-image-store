...
export default function ProductCard({ product }: { product: IProduct }) {
  ...
  return (
    <div className="rounded-xl border border-white/10 bg-neutral-900 hover:border-white/20 transition-all duration-300">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <Link
            href={`/products/${product._id}`}
            className="inline-flex items-center gap-2 rounded-md bg-white text-black px-3 py-1.5 text-sm font-medium hover:bg-neutral-200 transition"
          >
